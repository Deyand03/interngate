...
<div class="p-6 md:p-8">
    ...
    <header class="mb-8">
        ...
        <p class="text-gray-500 mt-1">Buat, edit, dan kelola semua program magang yang ditawarkan oleh perusahaan Anda.</p>
    </header>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="#" class="link link-primary font-semibold">15 Pelamar</a>
                            </td>
                            <td class="text-center">
                            ...
                            <td class="text-center">
                                <div class="dropdown dropdown-end">
                                    <div tabindex="0" role="button" class="btn btn-sm btn-ghost">Opsi <i class="fa-solid fa-chevron-down ml-1"></i></div>
                                    <ul tabindex="0" class="dropdown-content z-[1] menu p-2 shadow bg-base-100 rounded-box w-52">
                                        <li><a><i class="fa-solid fa-users"></i> Lihat Pelamar</a></li>
                                        <li><a><i class="fa-solid fa-pen-to-square"></i> Edit Program</a></li>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="#" class="link link-primary font-semibold">45 Pelamar</a>
                            </td>
                            <td class="text-center">
            ...
            <div class="p-6 space-y-6">
                ...
                <div class="space-y-4">
                    <div class="form-control w-full">
                        ...
                        <input type="text" name="judul" placeholder="cth: Backend Web Developer (Laravel)" class="input input-bordered w-full" required/>
                    </div>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div class="form-control w-full">
                            ...
                            <input type="number" name="kuota" placeholder="cth: 5" class="input input-bordered w-full" required />
                        </div>
                    </div>
                </div>
                ...
                <div class="space-y-4">
                    <div class="form-control w-full">
                        ...
                        <textarea name="deskripsi_program" class="textarea textarea-bordered h-24 w-full" placeholder="Jelaskan tentang tugas, tanggung jawab, dan apa yang akan dipelajari mahasiswa..." required></textarea>
                    </div>
                    <div class="form-control w-full">
                        <label class="label"><span class="label-text font-semibold">Kualifikasi</span></label>
                        <textarea name="kualifikasi" class="textarea textarea-bordered w-full" rows="5" placeholder="Sebutkan kualifikasi yang dibutuhkan, pisahkan setiap poin dengan baris baru..." required></textarea>
                    </div>
                </div>
                ...
                <div class="space-y-5">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div class="form-control w-full">
                            <label class="label w-full"><span class="label-text text-center text-md font-semibold w-full">Batas Pendaftaran</span></label>
                            <input type="date" name="batas_pendaftaran" class="input input-bordered w-full" required/>
                        </div>
                        <div class="form-control w-full">
                            <label class="label w-full"><span class="label-text w-full text-center font-semibold">Awal Magang</span></label>
                            <input type="date" name="awal_magang" class="input input-bordered w-full" required/>
                        </div>
                        <div class="form-control w-full">
                            <label class="label w-full"><span class="label-text w-full text-center font-semibold">Selesai Magang</span></label>
                            <input type="date" name="selesai_magang" class="input input-bordered w-full" required/>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-control w-full">
                    <label class="label"><span class="label-text font-semibold">Gambar Banner Program (Opsional)</span></label>
                    <input type="file" name="gambar" class="file-input file-input-primary file-input-bordered w-full" />
                    <div class="label">
