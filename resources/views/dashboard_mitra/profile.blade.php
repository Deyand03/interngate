...
<div class="lg:col-span-2 bg-white p-8 rounded-xl shadow">
  ...
  <div id="view-biodata" class="mt-6 grid grid-cols-1 md:grid-cols-2 gap-4">
    ...
    <div class="pt-4">
      <button onclick="toggleForm()" type="button" class="btn btn-primary w-full">Edit Biodata</button>
    </div>
  </div>

  <!-- Form Edit (Tersembunyi Awalnya) -->
  <form id="form-edit" class="hidden mt-6 grid grid-cols-1 md:grid-cols-2 gap-4" onsubmit="updateBiodata(event)">
