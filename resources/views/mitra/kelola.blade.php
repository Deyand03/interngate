                            ...
                            @forelse ($programs as $program)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="#"
                                            class="text text-primary font-semibold">{{ $program->pendaftaran_count }}
                                            Pelamar</a>
                                    </td>
                                    <td class="text-center">
                                        <div
                                            class="badge {{ $program->status == 'buka' ? 'badge-success' : 'badge-neutral' }} text-white">
                                        ...
                                        <div class="dropdown dropdown-end">
                                            ...
                                            <ul tabindex="0"
                                                ...
                                                <li>
                                                    ...
                                                    <a href="#"><i class="fa-solid fa-users"></i> Lihat Pelamar</a>
                                                </li>
                                                <li>
                                                ...
                                                @if ($program->status_magang != 'selesai')
                                                    <li>
                                                        <form
                                                            action="{{ route('mitra.status', $program->id) }}"
                                                            method="POST" class="w-full">
                                                            @csrf
                                                            @method('patch')
                                                            <button type="submit"
                                                                class="flex items-center gap-2 w-full px-4 py-2 text-left hover:bg-base-200 rounded-lg">
                                                                @if ($program->status_magang == 'buka')
                                                                    <i class="fa-solid fa-lock"></i> Tutup Lowongan
                                                                @else
                                                                    <i class="fa-solid fa-lock-open"></i> Buka Lowongan
                                                                @endif
                                                            </button>
                                                        </form>
                                                    </li>
                                ...
                                <tr>
                                    <td colspan="5" class="text-center py-12">
                                        <div class="flex flex-col items-center">
                                            ...
                                            <button class="btn btn-primary btn-sm mt-6" onclick="edit_biodata_modal.showModal()"">Buat
